...
mob = {
    'aircruiser': {
        ...
        'descriptions': [
            [['foe_intro'],
                u"{0} готовится к бою 1", ['foe_name'], 0],
            [['foe_intro'],
                u"{0} готовится к бою 2", ['foe_name'], 0],
            [['foe_intro'],
                u"{0} готовится к бою 3", ['foe_name'], 0],
            [['foe_fear'],
                u"{0} бежит в страхе", ['foe_name'], 0],
            [['foe_dead', 'dragon_undamaged'],
                u"{0} побеждает", ['dragon_name'], 0],
            [['foe_dead', 'dragon_wounded'],
                u"{0} наностит дракону ранение, но {1} побеждает", ['foe_name', 'dragon_name'], 0],
            [['foe_alive', 'dragon_wounded'],
                u"{0} наносит дракону серьёзную рану", ['foe_name'], 0],
            [['foe_alive', 'dragon_undamaged'],
                u"Бой продолжается некоторое время но никто не может взять верх", [], 0],
            [['foe_alive', 'lost_head'],
                u"{0} метким ударом сносит голову дракону", ['foe_name'], 0],
            [['foe_dead', 'lost_head'],
                u"{0} побеждает, но одна из его голов умирает от полученых ран", ['dragon_name'], 0],
            [['dragon_dead'],
                u"{0} умирает от полученных ран", ['dragon_name'], 0]
        ]
    },
    ...
    'battleship': {
        ...
        'descriptions': [
            [['foe_intro'],
                u"{0} бросается на {1}", ['foe_name', 'dragon_name'], 0],
            [['foe_intro'],
                u"{0} роет копытами землю, готовясь напасть", ['foe_name'], 0],
            [['foe_intro'],
                u"{0} готовится к бою", ['foe_name'], 0],
            [['foe_fear'],
                u"{0} бежит в страхе от {1}", ['foe_name', 'dragon_name'], 0],
            [['foe_dead', 'dragon_undamaged'],
                u"{0} побеждает", ['dragon_name'], 0],
            [['foe_dead', 'dragon_wounded'],
                u"{0} наносит сильный удар, {1} яростным контрударом убивает его", ['foe_name', 'dragon_name'], 0],
            [['foe_alive', 'dragon_wounded'],
                u"{0} наносит сильный удар и уворачивается от ответного удара", ['foe_name'], 0],
            [['foe_alive', 'dragon_undamaged'],
                u"Противники маневрируют, готовясь к удару", [], 0],
            [['foe_alive', 'lost_head'],
                u"{0} метким ударом сносит голову", ['foe_name'], 0],
            [['foe_dead', 'lost_head'],
                u"{0} ценой головы убивает супостата", ['dragon_name'], 0],
            [['dragon_dead'],
                u"{0} умирает от полученных ран", ['dragon_name'], 0]
        ]
    },
    ...
    'catapult': {
        ...
        'descriptions': [
            ...
            [['foe_alive', 'lost_head'],
                u"{0} метким ударом сносит голову дракону", ['foe_name'], 0],
            [['foe_dead', 'lost_head'],
                u"{0} побеждает, но одна из его голов умирает от полученых ран",
             ['dragon_name'], 0],
            [['dragon_dead'],
                u"{0} умирает от полученных ран", ['dragon_name'], 0]
        ]
    ...
    'city': {
        ...
        'modifiers': [],  # особые модификаторы
        'image': 'city',  # фоновое изображение для драки в "img/scene/fight/%s.png"
        # набор описаний сцены боя
        'descriptions': [
