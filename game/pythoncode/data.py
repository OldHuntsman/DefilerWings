...
dark_army = {
    "grunts": {
        0: u"После поражения Госпожи в Битве Шести Воинств от её армии остались жалкие ошмётки. Немногие выжившие "
           u"гоблины прячутся по своим пещерам и размножаются словно кролики в попытке пополнить ряды войск. ",
        5: u"Хорошая новость: на бесплодных равнинах собралось достаточно агрессивных тварей чтобы из них можно "
           u"было собрать настоящее войско. Плохая: это войско будет уступать по численности тому что могут собрать "
           u"Вольные Народы.",
        10: u"Пещер и дыр уже не хватает чтобы дать укрытие всем уродливым воинам живущим под рукой Госпожи. "
            ...
            u"трудолюбиво окружаемые рвами, насыпями и частоколами. На первый взгляд бойцов тут не меньше чем может "
            u"выставить на поле коалиция Вольных Народов.",
        20: u"Взглянув на бесплодные равнины в ночи трудно понять где кончается усыпанное звёздами небо и начинается "
            u"выгоревшая земля с мириадами костров дающих свет и тепло воинам Госпожи. Днём можно увидеть многие "
            u"тысячи шатров покрывающие долину словно заросли ядовитых грибов. Тут и там снуют вестовые и дозорные. "
    ...
    "elites": {
        0: u"Но каково бы не было количество этих войск их главной слабостью является отсутствие элитных бойцов. "
           u"Столкнувшись на поле боя с великанами, эльфийскими магами и боевыми машинами цвергов, Госпожа поняла что "
           u"противостоять им смогут лишь существа многократно превосходящие по силе людей или гоблинов. Именно таких "
           u"должны породить драконы. Именно в них отчаянно нуждается войско Госпожи.",
        1: u"Тут и там можно заметить огромные силуэты элитных бойцов. Их тут не много, однако в ключевой момент они "
           u"встанут на острие атаки. ",
        3: u"На каждый отряд мелких тварей вроде гоблинов тут приходится хотя бы один элитный боец, порождённый "
           u"драконом от самой сильной крови Вольных Народов. Каждый их этих могучих гигантов сам стоит в бою целой "
           u"армии.",
        6: u"В этом войске столько элитных бойцов, что обычная мелочь вроде гоблинов служит лишь для разведки и "
           u"поддержки их действий. Ударную мощь обеспечивают уродливые гиганты порождённые драконами от самой могучей "
           u"крови Вольных Народов."
    },
    "diversity": {
        0: u"Армия тьмы не отличается разнообразием, подавляющее большинство бойцов относится к одному единственному "
           u"виду. Воины Вольных Народов уже отлично умеют сражаться с такими тварями и обладают отработанной тактикой "
           u"против них.",
        2: u"Разнообразие войск не слишком велико, хотя порождения драконов будут выгодно дополнять обычных гоблинов "
           u"на поле боя. Тем не менее Вольным Народам не составит труда выработать тактику противодействия и изучить "
           u"сильные и слабые места всех бойцов Госпожи.",
        4: u"Порождения драконов собравшиеся под знамёна Госпожи очень разнообразны. Здесь есть дылды и коротышки, "
           u"стремительные лазутчики и массивные штурмовики, всех цветов, размеров и форм. Кого-то украшает чеушая, "
           u"кого-то рога. Выгодно дополняя друг друга на поле боя вся эта пёстрая компания не позволит Вольным "
           u"Народам использовать простую и привычную тактику боя.",
        7: u"Тут столько разнообразных тварей что наверное даже сама Госпожа не сможет различить их всех. "
           u"Бесконтрольно смешиваясь между собой отродья драконов порождают новые мутатнтные гибриды с невероятными "
           u"свойствами. Когда начнётся война, Вольные Народы не будут знать как бороться с ними."
    },
    "equipment": {
        0: u"Денег на снаряжение армии катастрофически не хватает. Воины Госпожи ходят в одних набедренных повязках, "
           u"вооружаются кривыми дубинами и заострёнными палками вместо копий. Только некоторые могут позволить себе "
           u"грубую броню из плохо обработанных шкур.",
        1: u"Армия снаряжена по минимуму. Рядовые воины могут надеяться получить железное копьё, плетёный щит и "
           u"простой стёганный доспех. Элита вооружается чуть лучше, но всё же картина далека от желаемой.",
        2: u"Сокровища драконов позволили неплохо снарядить бойцов Госпожи. Даже у рядовых воинов есть полный комплект "
           u"вооружения и брони, а элита закована в воронёную сталь с ног до головы. Ряды чёрных пик и щитов на поле "
           u"боя будут смотреться очень внушительно.",
        3: u"За долгие годы драконы скопили для Госпожи такую кучу сокровищ, что её с лихвой хватает для вооружения "
           u"всей армии по самому высшему разряду. Тяжёлая пехота и кавалерия вооружена до зубов, а элитные бойцы "
           u"щеголяют волшебным оружием и доспехами. "
    },
    "force": {
        ...
        1000: u"В общем и целом Армия Тьмы достаточно боеспособна чтобы иметь шансы в битвах с войском Вольных "
              u"Народов. Однако полной уверенности в победе быть не может.",
