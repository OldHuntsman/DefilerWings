...
reputation_gain = {
    1: "Этот поступок люди наверняка заметят.",
    3: "Дурная слава о ваших поступках разносится по королевству.",
    5: "Сегодня вы стяжали немалую дурную славу.",
    10: "Об этом деянии услышат  жители всего королевства. И ужаснутся." ,
    25: "О деянии столь ужасном будут сложены легенды, которые не забудутся и через сотни лет"
    }
