...
quest_list = ( #TODO: внести все выполнимые на сегодня квесты
        ...
        },
        {
            ...
            'text'    : u"Снизить боеспособность королевства.", # текст квеста, {0} будет заменён на требуемый уровень
        ...
        },
        {
            ...
            'unique' : 'giantess' # наличие этого ключа - задание выполняется только один раз в течение игры, значение - ключ для game.unique 
        },
    )
