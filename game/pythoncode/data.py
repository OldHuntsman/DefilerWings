...
quest_list = (  # TODO: внести все выполнимые на сегодня квесты
    ...
    {
        'min_lvl': 4,  # минимальный уровень дракона для получения квеста
        'max_lvl': 4,  # максимальный уровень дракона для получения квеста
        ...
        # кортеж с описанием препятствий для выполнения квеста, 'impassable_coomb' - буреломный овраг, квест не выполнится с этим типом логова
        'task_requirements': (
    ...
    },
    {
        ...
        # кортеж с требованиями, для выполнения задания нужно выполнить любое из них, 'victory' - заглушка для победы
    },
)
...
dark_army = {
    "grunts": [
        u"После поражения Госпожи в Битве Шести Воинств от её армии остались жалкие ошмётки. Немногие выжившие гоблины прячутся по своим пещерам и размножаются словно кролики в попытке пополнить ряды войск. ",
        u"Хорошая новость: на бесплодных равнинах собралось достаточно агрессивных тварей чтобы из них можно было собрать настоящее войско. Плохая: это войско будет уступать по численности тому что могут собрать Вольные Народы.",
        u"Пещер и дыр уже не хватает чтобы дать укрытие всем уродливым воинам живущим под рукой Госпожи. Бесплодные равнины стали местом огромной стройки - тут и там возникают целые городки из шатров, трудолюбиво окружаемые рвами, насыпями и частоколами. На первый взгляд бойцов тут не меньше чем может выставить на поле коалиция Вольных Народов.",
        u"Взглянув на бесплодные равнины в ночи трудно понять где кончается усыпанное звёздами небо и начинается выгоревшая земля с мириадами костров дающих свет и тепло воинам Госпожи. Днём можно увидеть многие тысячи шатров покрывающие долину словно заросли ядовитых грибов. Тут и там снуют вестовые и дозорные. Эта огромная Орда захлестнёт малочисленные войска Вольных Народов словно морской прибой."
    ],
    "elites": [
        u"Но каково бы не было количество этих войск их главной слабостью является отсутствие элитных бойцов. Столкнувшись на поле боя с великанами, эльфийскими магами и боевыми машинами цвергов, Госпожа поняла что противостоять им смогут лишь существа многократно превосходящие по силе людей или гоблинов. Именно таких должны породить драконы. Именно в них отчаянно нуждается войско Госпожи.",
        u"Тут и там можно заметить огромные силуэты элитных бойцов. Их тут не много, однако в ключевой момент они встанут на острие атаки. ",
        u"На каждый отряд мелких тварей вроде гоблинов тут приходится хотя бы один элитный боец, порождённый драконом от самой сильной крови Вольных Народов. Каждый их этих могучих гигантов сам стоит в бою целой армии.",
        u"В этом войске столько элитных бойцов, что обычная мелочь вроде гоблинов служит лишь для разведки и поддержки их действий. Ударную мощь обеспечивают уродливые гиганты порождённые драконами от самой могучей крови Вольных Народов."
    ],
    "diversity": [
        u"Армия тьмы не отличается разнообразием, подавляющее большинство бойцов относится к одному единственному виду. Воины Вольных Народов уже отлично умеют сражаться с такими тварями и обладают отработанной тактикой против них.",
        u"Разнообразие войск не слишком велико, хотя порождения драконов будут выгодно дополнять обычных гоблинов на поле боя. Тем не менее Вольным Народам не составит труда выработать тактику противодействия и изучить сильные и слабые места всех бойцов Госпожи.",
        u"Порождения драконов собравшиеся под знамёна Госпожи очень разнообразны. Здесь есть дылды и коротышки, стремительные лазутчики и массивные штурмовики, всех цветов, размеров и форм. Кого-то украшает чеушая, кого-то рога. Выгодно дополняя друг друга на поле боя вся эта пёстрая компания не позволит Вольным Народам использовать простую и привычную тактику боя.",
        u"Тут столько разнообразных тварей что наверное даже сама Госпожа не сможет различить их всех. Бесконтрольно смешиваясь между собой отродья драконов порождают новые мутатнтные гибриды с невероятными свойствами. Когда начнётся война, Вольные Народы не будут знать как бороться с ними."
    ],
    "equipment": [
        u"Денег на снаряжение армии катастрофически не хватает. Воины Госпожи ходят в одних набедренных повязках, вооружаются кривыми дубинами и заострёнными палками вместо копий. Только некоторые могут позволить себе грубую броню из плохо обработанных шкур.",
        u"Армия снаряжена по минимуму. Рядовые воины могут надеяться получить железное копьё, плетёный щит и простой стёганный доспех. Элита вооружается чуть лучше, но всё же картина далека от желаемой.",
        u"Сокровища драконов позволили неплохо снарядить бойцов Госпожи. Даже у рядовых воинов есть полный комплект вооружения и брони, а элита закована в воронёную сталь с ног до головы. Ряды чёрных пик и щитов на поле боя будут смотреться очень внушительно.",
        u"За долгие годы драконы скопили для Госпожи такую кучу сокровищ, что её с лихвой хватает для вооружения всей армии по самому высшему разряду. Тяжёлая пехота и кавалерия вооружена до зубов, а элитные бойцы щеголяют волшебным оружием и доспехами. "
    ],
    "force": [
        ...
        u"В общем и целом Армия Тьмы достаточно боеспособна чтобы иметь шансы в битвах с войском Вольных Народов. Однако полной уверенности в победе быть не может.",
        u"За долгие годы подготовки Армия Тьмы не просто воспаряла, но и стала могущественнее чем когда либо. Войско Вольных Народов будет смято и растоптано этой неодолимой силой."
    ]
}
