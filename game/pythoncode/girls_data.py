...
girls_texts = {
    ...
    # %(situation)s - ситуативные описания - что украли, кого родила и прочее
    'girl': {  # используется, если нет подходящего текста или отсутствует нужный тип девушки
               ...
               'spawn': (  # Описание родов
                           u"%(girl_name)s рожает кучу тварей, известных людям под именем %(situation)s",
               ),
