...
gem_cut_description_rus = {
    ' ': { 
        ...
        'they':{'nominative': u'', 'genitive': u'', 'ablative': u''}},
    'polished': {   
        'he': {'nominative': u'необработанный ', 'ablative': u''}, # 'ablative' не отображается, чтобы не портить описание вещи
...
gem_description_rus = {
    ...
    "elven_beryll": {
        'he': {'nominative': u'эльфийский берилл', 'genitive': u"эльфийских берилла",  'ablative': u'эльфийским бериллом'},
