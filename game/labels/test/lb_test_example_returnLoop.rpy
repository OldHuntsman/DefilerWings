...
label lb_test_example_returnLoop:
    ...
    while True:
        nvl clear
        # Дальше могут идти варианты. Из всех них мы попадем обратно в цикл, потому что в конце них стоит return - т.е. продолжить с того место где остановились. Иначе игра закончится
        menu:
            "Некоторый выбор"
            "Вариант 1":
