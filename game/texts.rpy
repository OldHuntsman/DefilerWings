...
# Тексты для особых мест
    ...
    txt_place_wooden_fort = [['Деревянный форт. Бинго!'],
        ['Старый рыцарь живущий тут наверняка не сдастся без боя.'],
        ['Не обращая внимания на бегущую в ужасе челядь, %(dragon_name)s обшаривает поместье в поисках ценностей:'],
        ['В просторной и светлой комнате на самом последнем этаже дрожит спрятавшись под кроватью дочь убитого рыцаря. Но %(dragon_name)s способен учуять запах невинной плоти за много миль, от него не скрыться в маленькой комнате.'],
        ['Укрепления не спасли эту ныне уже безлюдную усадьбу от разграбления, однако крепкие стены могут послужить хорошей защитой для драконьих сокровищ. Не слишком крупный ящер мог бы устроить в винном погребе уютное логово, надо только протиснуться в узкие двери.'],
    ...
    txt_place_abbey = [['Укреплённый монастырь. Бинго!'],
        ['Старый рыцарь живущий тут наверняка не сдастся без боя.'],
        ['Не обращая внимания на бегущую в ужасе челядь, %(dragon_name)s обшаривает поместье в поисках ценностей:'],
        ['В просторной и светлой комнате на самом последнем этаже дрожит спрятавшись под кроватью дочь убитого рыцаря. Но %(dragon_name)s способен учуять запах невинной плоти за много миль, от него не скрыться в маленькой комнате.'],
        ['Укрепления не спасли эту ныне уже безлюдную усадьбу от разграбления, однако крепкие стены могут послужить хорошей защитой для драконьих сокровищ. Не слишком крупный ящер мог бы устроить в винном погребе уютное логово, надо только протиснуться в узкие двери.'],
    ...
    txt_place_castle = [['Каменная крепость. Бинго!'],
        ['Старый рыцарь живущий тут наверняка не сдастся без боя.'],
        ['Не обращая внимания на бегущую в ужасе челядь, %(dragon_name)s обшаривает поместье в поисках ценностей:'],
        ['В просторной и светлой комнате на самом последнем этаже дрожит спрятавшись под кроватью дочь убитого рыцаря. Но %(dragon_name)s способен учуять запах невинной плоти за много миль, от него не скрыться в маленькой комнате.'],
        ['Укрепления не спасли эту ныне уже безлюдную усадьбу от разграбления, однако крепкие стены могут послужить хорошей защитой для драконьих сокровищ. Не слишком крупный ящер мог бы устроить в винном погребе уютное логово, надо только протиснуться в узкие двери.'],
    ...
    txt_place_palace = [['Королевский замок. Бинго!'],
        ['Старый рыцарь живущий тут наверняка не сдастся без боя.'],
        ['Не обращая внимания на бегущую в ужасе челядь, %(dragon_name)s обшаривает поместье в поисках ценностей:'],
        ['В просторной и светлой комнате на самом последнем этаже дрожит спрятавшись под кроватью дочь убитого рыцаря. Но %(dragon_name)s способен учуять запах невинной плоти за много миль, от него не скрыться в маленькой комнате.'],
        ['Укрепления не спасли эту ныне уже безлюдную усадьбу от разграбления, однако крепкие стены могут послужить хорошей защитой для драконьих сокровищ. Не слишком крупный ящер мог бы устроить в винном погребе уютное логово, надо только протиснуться в узкие двери.'],
    ...
    txt_enc_forest_guardian = [['Дракон некоторое время бродит по лесу. Внезапно...'],
    ...
    txt_place_jotun = [['Ледяная цитадель. Тут живёт Йотун.'],
        ['Внутри ледяная великанша.'],
        ['Жилище ледяного великана теперь пустует. Тут можно устроить отличное логово.']]
    
    txt_place_ifrit = [['Вулканическая кузня. Тут живёт Ифрит.'],
