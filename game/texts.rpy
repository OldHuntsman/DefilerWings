...
# Тексты для особых мест
    ...
    txt_place_wooden_fort = [
        ...
        ['%(dragon_type)s издаёт победный рык. Больше никто не стоит у него на пути и форт на холме теперь беззащитен.']
    ]
    ...
    txt_place_abbey = [
        ...
        ['В задней части обители находятся кельи монашек. Большинство из них невинны, хотя многие так стары что давно протухли, но есть тут и особый сладкий запах. Ориентируясь по нему %(dragon_type)s обнаруживает в самой дальшей келье деву благородных кровей, которая только готовилась принять постриг в монахини. Но теперь её ждёт совсем иная судьба!'],
